...
export const alertVariants = tv({
	...
	variants: {
		variant: {
			...
			info:
				"border-info/50 text-info text-info dark:border-info [&>svg]:text-info",
			secondary:
				"border-secondary/50 text-secondary text-secondary dark:border-secondary [&>svg]:text-secondary",
		},
	},
	defaultVariants: {
		variant: "default",
