...
<div class="flex min-h-[80vh] flex-col items-center justify-center">
	...
	<h1 class="mb-4 text-4xl font-bold text-center inline-flex animate-text-gradient bg-gradient-to-r from-[#917e4e] via-[#000000] to-[#917e4e] bg-[200%_auto] text-transparent bg-clip-text">Bem-vindo ao Sistema do Duarte</h1>
